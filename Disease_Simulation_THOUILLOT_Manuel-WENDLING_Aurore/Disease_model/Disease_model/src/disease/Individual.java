...
//GETTERS :
	...
	/**
	 * Tells whether this individual is identified as infected
...
//=================== Infecting individuals ========================
	...
	/**
	 * Method telling whether an individual belongs or not to this individual's radius of infection
	...
	/**
	 * Method to decide whether this individual infects another individual belonging to its radius of infection
	...
	/**
	 * Method deciding whether this individual is identified as infected depending on the probability of identifying infected people stored in disease
	 */
	...
	/**
	 * Method deciding whether this individual dies from the disease
...
//=================== Implementing social distancing ========================		
	...
	/**
	 * Method telling whether an individual belongs or not to this individual's social distance radius
	 * @param i the individual for which we want to know whether it belongs or not to this individual's social distance radius
